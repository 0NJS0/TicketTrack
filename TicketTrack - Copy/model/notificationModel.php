<?php
    ...
    function addRegistrationNotification($message) {
        ...
        if (mysqli_query($con, $sql)) {
            ...
            $sql_admins = "SELECT username FROM user WHERE user_type = 'admin'";
    ...
    function addOfferNotification($message) {
        ...
        if (mysqli_query($con, $sql)) {
            ...
            $sql_admins = "SELECT username FROM user WHERE user_type = 'traveller'";
            $result = mysqli_query($con, $sql_admins);
    ...
    function getUnreadNotifications($username) {
        ...
        $sql = "SELECT n.id, n.message, n.type, n.time 
                FROM notification n
